      ...
      require("image").setup({
        ...
        integrations = {
          ...
          markdown = {
            ...
            only_render_image_at_cursor = vim.g.neovim_mode == "skitty"
                and false
              or true,
        ...
        max_height_window_percentage = vim.g.neovim_mode == "skitty" and 30
          or 40,
        ...
        editor_only_render_when_focused = vim.g.neovim_mode == "skitty"
            and false
          or true,
